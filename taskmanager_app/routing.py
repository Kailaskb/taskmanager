...
from taskmanager_app.consumer_com import CombinedConsumer
from taskmanager_app.consumer_test import TestCombinedConsumer
...
websocket_urlpatterns = [
    ...
    re_path(r'3010/$', CombinedConsumer.as_asgi()),
    re_path(r'3011/$', TestCombinedConsumer.as_asgi()),
